...
export default function MyForm() {
  ...
  const [dropdown1, setDropdown1] = useState(''); // State for the first dropdown
  const [dropdown2, setDropdown2] = useState(''); // State for the second dropdown
      ...
      <Stack spacing={8} mx={"auto"} maxW={"lg"} py={12} px={6}>
        ...
        >
          <Stack spacing={4}>
            ...
            <FormControl id="subject"> {/* Corrected the id attribute here */}
